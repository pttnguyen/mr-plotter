    ...
    $.fn.extend({  
        colResizable: function(options) {           
            var defaults = {
				...
				minWidth: 220, 					//minimum width value in pixels allowed for a column 
